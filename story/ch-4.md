...
Seeing Shchavel House in daylight, even dimmed as it was by curtains and dust, gave Artemis a much clearer view of it. She counted the number of idols and books on a random bookshelf: about twenty idols, and thirty books. Call it an even twenty-five. Then multiply by the number of bookshelves in the hallway, eight… multiply by the number of storeys above the ground floor, two… and that would make a total of four hundred each of books and idols in the two hallways, not counting the fireplace mantels. Artemis selected a document at random from one of the shelves, curious. It was a small, dusty, hardcover book, forest green with a gold trim. _Das sibirisch Teertier_, by one Johannes Praetorius. She found it bookmarked with a note in barely legible handwritten Russian, reading, "The Siberian tar animal, Johannes Praetorius Zeitlingensis, 1681. Published posthumously. First known scientific treatise on abominations. Use German translator." Artemis reshelved the book.
